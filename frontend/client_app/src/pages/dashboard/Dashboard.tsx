      ...
      <div className="dashboard-page">
        <div className="alert alert-warning">
          {t("dashboard.pleaseLogin", {
            defaultValue: "Por favor, faça login para ver o dashboard",
          })}
        </div>
      </div>
    );
    ...
    return (
      <div className="dashboard-page">
        <div className="text-center py-5">
          ...
          <p className="mt-3">
            {t("dashboard.loading", {
              defaultValue: "A carregar dashboard...",
            })}
          </p>
        </div>
      </div>
      ...
      <div className="dashboard-header">
        ...
        <p className="dashboard-subtitle">
          {t("dashboard.subtitle", {
            defaultValue: "Resumo rápido da sua atividade",
          })}
        </p>
      </div>
      ...
      <div className="dashboard-stats-grid">
        <DashboardStatCard
          ...
          title={t("dashboard.vehicles", {
            defaultValue: "Veículos Registrados",
          })}
          value={stats.totalVehicles}
          description={formatCountDescription(
            stats.totalVehicles,
            t("dashboard.vehicleDescriptionSingular", {
              defaultValue: "veículo ativo",
            }),
            t("dashboard.vehicleDescriptionPlural", {
              defaultValue: "veículos ativos",
            })
          )}
          color="red"
        ...
        <DashboardStatCard
          ...
          title={t("dashboard.futureAppointments", {
            defaultValue: "Agendamentos Futuros",
          })}
          value={stats.futureAppointments}
          description={formatCountDescription(
            stats.futureAppointments,
            t("dashboard.appointmentDescriptionSingular", {
              defaultValue: "agendamento pendente",
            }),
            t("dashboard.appointmentDescriptionPlural", {
              defaultValue: "agendamentos pendentes",
            })
          )}
          color="blue"
        ...
        <DashboardStatCard
          ...
          title={t("dashboard.completedServices", {
            defaultValue: "Serviços Realizados",
          })}
        ...
        <div className="dashboard-recent-section">
          <h2 className="section-title">
            {t("dashboard.recentActivity", {
              defaultValue: "Atividade Recente",
            })}
          </h2>
            ...
            <table className="recent-appointments-table">
              <thead>
                <tr>
                  ...
                  <th>
                    {t("dashboard.table.vehicle", { defaultValue: "Veículo" })}
                  </th>
                  <th>
                    {t("dashboard.table.services", {
              ...
              <tbody>
                {stats.recentAppointments.map((appointment) => (
                  <tr key={appointment.id}>
                    <td
                      data-label={t("dashboard.table.date", {
                        defaultValue: "Data",
                      })}
                    >
                    ...
                    <td
                      data-label={t("dashboard.table.vehicle", {
                        defaultValue: "Veículo",
                      })}
                    >
                      {formatVehicleInfo(appointment.vehicle)}
                    </td>
                    <td
                      data-label={t("dashboard.table.services", {
                        defaultValue: "Serviços",
                      })}
                    >
                    ...
                    <td
                      data-label={t("dashboard.table.status", {
                        defaultValue: "Estado",
                      })}
                    >
        ...
        <div className="no-recent-activity">
          ...
          <h3>
            {t("dashboard.noRecentActivity", {
              defaultValue: "Sem atividade recente",
            })}
          </h3>
          <p>
