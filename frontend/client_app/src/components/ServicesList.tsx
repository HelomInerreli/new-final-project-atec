    ...
    <>
      ...
      <Modal show={showContactModal} onHide={() => setShowContactModal(false)} centered>
        <Modal.Header closeButton>
          <Modal.Title>{t('servicesPage.contactUs', 'Contacte-nos')}</Modal.Title>
        </Modal.Header>
        <Modal.Body>
          <p>
            <strong>Email:</strong> <a href="mailto:projetodghhn@gmail.com">projetodghhn@gmail.com</a>
          </p>
          <p>
            <strong>Telefone:</strong> <a href="tel:+351123456789">+351 123 456 789</a>
          </p>
        </Modal.Body>
        <Modal.Footer>
