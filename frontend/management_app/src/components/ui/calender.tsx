    ...
    <DayPicker
      ...
      classNames={{
        ...
        nav_button: cn(
          ...
          "h-7 w-7 !bg-transparent p-0 opacity-50 hover:opacity-100 border-slate-200 text-slate-900 hover:bg-slate-100"
        ),
        ...
        head_row: "flex",
        head_cell:
          "text-slate-500 rounded-md w-9 font-normal text-[0.8rem] shrink-0",
        ...
        day: cn(
          ...
          "h-9 w-9 p-0 font-normal aria-selected:opacity-100 bg-transparent text-slate-900 hover:bg-slate-100 hover:text-slate-900"
        ),
        day_range_end: "day-range-end",
        day_selected:
          "bg-[#E11D48] text-white hover:bg-[#E11D48] hover:text-white focus:bg-[#E11D48] focus:text-white",
