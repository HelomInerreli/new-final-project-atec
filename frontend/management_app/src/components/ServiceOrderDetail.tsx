...
//                   const isLatest = i === (order.parts ?? []).length - 1;
//                   const addedDate = p.created_at ? new Date(p.created_at) : new Date();
//                   const time = addedDate.toLocaleTimeString([], { hour: "2-digit", minute: "2-digit" });
                  
//                   return (
//                     <div key={i} className={`timeline-item ${isLatest ? "active" : ""}`}>
//                       <div className="timeline-left">
//                         <div className="timeline-month">Peça</div>
//                         <div className="timeline-time">{time}</div>
//                       </div>
//                       <div className="timeline-line" />
//                       <div className="timeline-content">
